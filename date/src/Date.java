public class Date {
	...
	private void setDay(int day) {
		if (day < 1 || day > 31) {
			throw new IllegalArgumentException("day must be between or equal to 1 and 31.");
		}
		if ((isThirtyDayMonth() && day > 30) || 
					((this.month == 2) && ((isLeapYear() && day > 29) || (!isLeapYear() && day > 28)))) {
			throw new IllegalArgumentException("Invalid day for month " + monthNames[month-1] + " and year " + year);
		}
		this.day = day;
	}

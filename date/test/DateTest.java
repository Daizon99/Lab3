...
class DateTest {
  ...
  /* Additional Tests to achieve higher coverage rates*/
  ...
  void nextDate_invalid_tc24() {
    ...
    //isEndOfMonth test cases
    @Test
    void nextDate_tc25() {
      Date today = new Date(2015, 2, 28);
      assertEquals(new Date(2015, 3, 1), today.nextDate());
  
      //assertTrue(new Date(2021, 2, 28).isEndOfMonth());
    }
  
    @Test
    void nextDate_tc26() {
      Date today = new Date(2016, 2, 28);
      assertEquals(new Date(2016, 2, 29), today.nextDate());
      //assertFalse(new Date(2020, 2, 28).isEndOfMonth());
    }

  //ToString test case
  @Test
  void toString_tc() {
    assertEquals("2020/January/31", new Date(2020, 1, 31).toString());
  }
  ...
  //IsLeapYear test case
  @Test
  void isLeapYear_true_tc() {
    assertTrue(new Date(2000, 2, 20).isLeapYear());
  }
}
